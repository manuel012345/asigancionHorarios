 ...
 <section class="col-sm-10">
                ...
                <div class="card mt-2">
                    <div class="card-header text-right bg-primary">
                        <h5 class="text-light">Centro</h5>
                    </div>
                    <div class="card-body row">
                        <!-- Cabecera de horas -->
            <form method="POST" action="<?php echo URL; ?>centro/IngresarCentro" enctype="multipart/form-data">
                  ...
                  <div class="register-form" >
                    ...
                    <div class="row">
                      ...
                      <div class=" form-group col-sm-3">
                        <label>Sede</label>
                        <select type="select"  id="idSede" name="idSede"  class="form-control" >
                         <option>Seleccione...</option>
                         <?php foreach ($sedes as $sede) { ?>
                          <option value="<?php echo $sede->idSede; ?>"> <?php echo $sede->nombre; ?>
                          </option>
                      <?php } ?>
                    </select>
                  </div>
                                ...
                                <table class="table-bordered text-center">
                                    ...
                                    <tbody>
                                        <?php foreach ($centros as $centro) { ?>
                                            <tr>
                                                <td>
                                                    <?php if (isset($centro->idCentro)) echo htmlspecialchars($centro->idCentro, ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                                <td>
                                                    <?php if (isset($centro->sede)) echo htmlspecialchars($centro->sede, ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                                <td>
                                                    <?php if (isset($centro->nombre)) echo htmlspecialchars($centro->nombre, ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                                <td>
                                                    <?php if (isset($centro->direccion)) echo htmlspecialchars($centro->direccion, ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                                <td>
                                                    <?php if (isset($centro->telefono)) echo htmlspecialchars($centro->telefono, ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                                <td>
                                                    <?php if (isset($centro->correo)) echo htmlspecialchars($centro->correo, ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                                <td>
                                                    <?php if (isset($centro->director)) echo htmlspecialchars($centro->director, ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                                <td>
                                                    <?php if (isset($centro->estado)) echo htmlspecialchars($centro->estado, ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                    </tbody>
